...
public class Persona implements Serializable{
	...
	public ArrayList<String> iterarLista(List<Producto> listaProductos  ){
		
		ArrayList<String> nombres = new ArrayList<String>();
		
		for(int i =0 ; i<listaProductos.size(); i++) {
			nombres.add(listaProductos.get(i).getNombreProducto());
		}
	...
	public String toString() {
		return "Persona [idPersona=" + idPersona + ", nombre=" + nombre + ", telefono=" + telefono + ", profesion="
				+ profesion + ", tipo=" + tipo + ", nacimiento=" + nacimiento + "]" + "ListaProductos=" + iterarLista(this.listaProductos);
	}
